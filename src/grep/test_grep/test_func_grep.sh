...
declare -a tests=(
"VAR -e int test_0_grep.txt"
"VAR -e int test_4_grep.txt"
)

declare -a extra=(
"-n -e for test_1_grep.txt test_2_grep.txt"
"-n -e for test_1_grep.txt"
"-n -e ^\} test_1_grep.txt"
"-c -e ^int test_1_grep.txt test_2_grep.txt"
"-e ^int test_1_grep.txt"
"-nivh -e = test_1_grep.txt test_2_grep.txt"
"-ie INT test_5_grep.txt"
"-ch test_1_grep.txt test_2_grep.txt"
"-n -e = -e out test_5_grep.txt"
"-iv -e int test_5_grep.txt"
"-in -e int test_5_grep.txt"
"-c -l aboba test_1_grep.txt test_5_grep.txt"
"-v -e ank test_1_grep.txt"
"-no -e ) test_5_grep.txt"
...
"-c -e . test_2_grep.txt"
"-l -e for no_file.txt test_2_grep.txt"
